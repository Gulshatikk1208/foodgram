    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/Gulshatikk1208/foodgram.git" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/Gulshatikk1208" className={styles.textLink}>Гульшат Гайфуллина</a>
            </p>
          </div>
        </aside>
      </div>
